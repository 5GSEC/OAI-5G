                   ...
                   e2node_type_t e2node_type)
{
  ...
  pdu.choice.initiatingMessage = (struct E2AP_InitiatingMessage *) calloc(1, sizeof(*pdu.choice.initiatingMessage));
                   ...
                   e2node_type_t e2node_type)
{
  ...
  { 
    ...
    updateItem->e2nodeComponentID.choice.e2nodeComponentInterfaceTypeS1 = (struct E2AP_E2nodeComponentInterfaceS1 *) calloc(1, sizeof(*updateItem->e2nodeComponentID.choice.e2nodeComponentInterfaceTypeS1));
  ...
  if (e2node_type == E2NODE_TYPE_GNB_CU || e2node_type == E2NODE_TYPE_GNB || e2node_type == E2NODE_TYPE_ENB)
  {
    ...
    updateItem->e2nodeComponentID.choice.e2nodeComponentInterfaceTypeE1 = (struct E2AP_E2nodeComponentInterfaceE1 *) calloc(1, sizeof(*updateItem->e2nodeComponentID.choice.e2nodeComponentInterfaceTypeE1));
  ...
  else if (e2node_type == E2NODE_TYPE_GNB_DU)
  {
    ...
    updateItem->e2nodeComponentID.choice.e2nodeComponentInterfaceTypeF1 = (struct E2AP_E2nodeComponentInterfaceF1 *) calloc(1, sizeof(*updateItem->e2nodeComponentID.choice.e2nodeComponentInterfaceTypeF1));
        ...
        uint32_t *len)
{
  ...
  pdu.choice.successfulOutcome = (struct E2AP_SuccessfulOutcome *) calloc(1, sizeof(*pdu.choice.successfulOutcome));
        ...
        ric_control_t *rc, uint8_t **buffer,uint32_t *len)
{
    ...
    pdu.choice.unsuccessfulOutcome = (struct E2AP_UnsuccessfulOutcome *) calloc(1, sizeof(*pdu.choice.unsuccessfulOutcome));
...
int global_e2_node_id(ranid_t ranid, E2AP_GlobalE2node_ID_t* node_id) {
    ...
    if (node_type == E2NODE_TYPE_ENB) 
    {
        ...
        node_id->choice.eNB = (struct E2AP_GlobalE2node_eNB_ID *) calloc(1, sizeof(*node_id->choice.eNB));
        MCC_MNC_TO_PLMNID(
                e2_conf[ranid]->mcc,
                e2_conf[ranid]->mnc,
        ...
        uint8_t *ind_message_buf, int message_length)
{
    ...
    e2ap_pdu->choice.initiatingMessage = (struct E2AP_InitiatingMessage *) calloc(1, sizeof(*e2ap_pdu->choice.initiatingMessage));
